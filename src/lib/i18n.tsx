...
const en: Dict = {
  ...
  "dash.liveOnMarketplace": "Live on marketplace",
  "dash.drafts": "Drafts",
  "dash.continueEditing": "Continue editing",
  "dash.reserved": "Reserved",
  "dash.heldWithPi": "Held with Pi",
  "dash.sold": "Sold",
  "dash.completedDeals": "Completed deals",
  "dash.totalViews": "Total views",
  "dash.acrossAllListings": "Across all listings",
  "dash.offersReceived": "Offers received",
  "dash.pendingResponse": "Pending your response",
  "dash.offersSent": "Offers sent",
  "dash.awaitingSeller": "Awaiting seller",
  "dash.orders": "Orders",
  "dash.buySellActivity": "Buy / sell activity",
  "dash.messages": "Messages",
  "dash.unreadInbox": "Unread in inbox",
  ...
  "dash.trustedBadge": "Trusted-seller badge",
  "dash.walletOverview": "Wallet overview",
  "dash.walletHint": "Connect inside Pi Browser to enable Buy Now, Reserve with Pi and payouts.",
  "dash.openWallet": "Open wallet",
  "dash.gcvReference": "Community GCV Reference",
  "dash.accountStatus": "Account status",
  "dash.verifiedSeller": "Verified seller",
  "dash.unverified": "Unverified",
  "dash.trustedActive": "Trusted seller badge active",
  "dash.submitId": "Submit ID to request verification",
  "dash.manage": "Manage",
  ...
  "profile.photoHint": "JPG or PNG, max ~2MB.",
  ...
  "profile.bioPlaceholder": "Tell buyers who you are…",
  "profile.saving": "Saving…",
  "profile.saveChanges": "Save changes",

  "wallet.balance": "Balance",
  "wallet.liveBalanceHint": "Live balance activates once the Pi Wallet is connected in the Pi Browser.",
  "wallet.rate": "Rate",
  "wallet.gcvRef": "GCV community reference",
  "wallet.marketplaceActivity": "Marketplace activity",
  "wallet.totalSpent": "Total spent",
  "wallet.totalEarned": "Total earned",
  "wallet.net": "Net",
  "wallet.viewOrders": "View orders",
  "wallet.viewOffers": "View offers",
  "wallet.disclaimer": "is a community ecosystem reference and is NOT an official Pi Network exchange rate. On-chain Pi payments and balances become active inside Pi Browser once Pi SDK integration is enabled.",

  "listings.all": "All",
  "listings.archived": "Archived",
  "listings.loading": "Loading…",
  "listings.noneYet": "No listings yet",
  "listings.createFirst": "Create your first premium listing in minutes.",
  "listings.createListing": "Create listing",
  "listings.edit": "Edit",
  "listings.view": "View",
  "listings.publish": "Publish",
  "listings.markReserved": "Mark reserved",
  "listings.markSold": "Mark sold",
  "listings.release": "Release",
  "listings.archive": "Archive",
  "listings.restore": "Restore",
...
const dictionaries: Record<LangCode, Dict> = {
  ...
  tr: partial({
    ...
    "dash.newMember": "Yeni üye",
    "dash.newListing": "Yeni ilan",
    "dash.myListings": "İlanlarım",
    "dash.profileCompletion": "Profil tamamlama",
    "dash.complete": "Tamamla",
    "dash.activeListings": "Aktif ilanlar",
    "dash.liveOnMarketplace": "Pazarda yayında",
    "dash.drafts": "Taslaklar",
    "dash.continueEditing": "Düzenlemeye devam et",
    "dash.reserved": "Rezerve",
    "dash.heldWithPi": "Pi ile tutuluyor",
    "dash.sold": "Satıldı",
    "dash.completedDeals": "Tamamlanan satışlar",
    "dash.totalViews": "Toplam görüntülenme",
    "dash.acrossAllListings": "Tüm ilanlarda",
    "dash.offersReceived": "Alınan teklifler",
    "dash.pendingResponse": "Yanıtını bekliyor",
    "dash.offersSent": "Gönderilen teklifler",
    "dash.awaitingSeller": "Satıcı bekleniyor",
    "dash.orders": "Siparişler",
    "dash.buySellActivity": "Alım / satım hareketleri",
    "dash.messages": "Mesajlar",
    "dash.unreadInbox": "Gelen kutusunda okunmamış",
    "dash.notifications": "Bildirimler",
    "dash.unreadAlerts": "Okunmamış uyarılar",
    "dash.favorites": "Favoriler",
    "dash.savedItems": "Kayıtlı ürünler",
    "dash.verification": "Doğrulama",
    "dash.verified": "Doğrulandı",
    "dash.pending": "Beklemede",
    "dash.trustedBadge": "Güvenilir satıcı rozeti",
    "dash.walletOverview": "Cüzdan özeti",
    "dash.walletHint": "Satın Al, Pi ile Rezerve Et ve ödemeleri etkinleştirmek için Pi Browser içinde bağlan.",
    "dash.openWallet": "Cüzdanı aç",
    "dash.gcvReference": "Topluluk Ekosistem Referansı",
    "dash.accountStatus": "Hesap durumu",
    "dash.verifiedSeller": "Doğrulanmış satıcı",
    "dash.unverified": "Doğrulanmamış",
    "dash.trustedActive": "Güvenilir satıcı rozeti aktif",
    "dash.submitId": "Doğrulama için kimlik gönder",
    "dash.manage": "Yönet",

    "profile.title": "Profilim",
    "profile.saved": "Profil kaydedildi",
    "profile.photoUpdated": "Fotoğraf güncellendi",
    "profile.changePhoto": "Fotoğrafı değiştir",
    "profile.photoHint": "JPG veya PNG, en fazla ~2MB.",
    ...
    "profile.preferredCurrency": "Tercih edilen para birimi",
    "profile.biography": "Biyografi",
    "profile.bioPlaceholder": "Alıcılara kendinden bahset…",
    "profile.saving": "Kaydediliyor…",
    "profile.saveChanges": "Değişiklikleri kaydet",

    "wallet.balance": "Bakiye",
    "wallet.liveBalanceHint": "Canlı bakiye, Pi Cüzdanı Pi Browser içinde bağlandığında aktifleşir.",
    "wallet.rate": "Kur",
    "wallet.gcvRef": "Topluluk GCV referansı",
    "wallet.marketplaceActivity": "Pazar yeri hareketleri",
    "wallet.totalSpent": "Toplam harcanan",
    "wallet.totalEarned": "Toplam kazanılan",
    "wallet.net": "Net",
    "wallet.viewOrders": "Siparişleri gör",
    "wallet.viewOffers": "Teklifleri gör",
    "wallet.disclaimer": "bir topluluk referans değeridir ve resmi Pi Network kuru DEĞİLDİR. Zincir üstü Pi ödemeleri ve bakiyeler, Pi SDK entegrasyonu etkinleştirildiğinde Pi Browser içinde aktif hale gelir.",

    "listings.all": "Tümü",
    "listings.archived": "Arşivlenmiş",
    "listings.loading": "Yükleniyor…",
    "listings.noneYet": "Henüz ilan yok",
    "listings.createFirst": "Dakikalar içinde ilk premium ilanını oluştur.",
    "listings.createListing": "İlan oluştur",
    "listings.edit": "Düzenle",
    "listings.view": "Görüntüle",
    "listings.publish": "Yayınla",
    "listings.markReserved": "Rezerve olarak işaretle",
    "listings.markSold": "Satıldı olarak işaretle",
    "listings.release": "Serbest bırak",
    "listings.archive": "Arşivle",
    "listings.restore": "Geri yükle",
    "listings.delete": "Sil",
  }),
  de: partial({
